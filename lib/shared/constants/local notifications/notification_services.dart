...

{
  ...
  initializeNotification()async
  {
    ...
    AndroidInitializationSettings('appicon2');
  ...
  tz.TZDateTime nextInstanceOfTenAM(int hour, int minutes, int remind,String repeat,String date) {
    ...
    // scheduledDate = afterRemind(remind, scheduledDate);
     print("$scheduledDate is schedule date");
...
displayNotification({required String title, required String body}) async {
  ...
  scheduleNotification2()async{
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      //nextInstanceOfTenAM(hour,  minutes, remind, repeat,date),
 ...
 scheduleNotification(int hour, int minutes, int remind,String repeat,String date, String taskname)async{
 ...
 // await displayNotification(title: taskname, body: date);
